-- Working HTTP solution using pg_net extension
-- This should work in Supabase without issues
...
BEGIN
    ...
    -- Use pg_net.http_post (Supabase's built-in HTTP extension)
