-- ================================================
-- SAFE PUSH NOTIFICATION SETUP FOR EDUBAZAAR
-- ================================================
-- This script safely sets up push notifications without conflicts
...
-- chat_notifications table should already exist, but add columns if missing
DO $$ 
BEGIN
