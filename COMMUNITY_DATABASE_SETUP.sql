-- =====================================================
-- COMMUNITY DATABASE SETUP FOR EDUBAZAAR
-- =====================================================
...
-- Apply forum reply count trigger
...
-- Apply resource like count trigger
...
-- Apply resource download count trigger
...
-- Apply group member count trigger
CREATE TRIGGER update_group_member_count_trigger 
    AFTER INSERT ON group_members
    FOR EACH ROW EXECUTE FUNCTION update_group_member_count();

-- =====================================================
-- STORAGE BUCKETS FOR COMMUNITY FEATURES
-- =====================================================

-- Create storage buckets for community features
-- Note: These need to be created in Supabase dashboard or via API
-- The following are the bucket names that should be created:

-- 1. 'community-avatars' - For user avatars in community features
-- 2. 'study-group-covers' - For study group cover images
-- 3. 'event-covers' - For event cover images
-- 4. 'study-resources' - For uploaded study materials
-- 5. 'resource-thumbnails' - For resource preview images

-- =====================================================
-- SAMPLE DATA (OPTIONAL)
-- =====================================================

-- Insert sample study groups (uncomment if needed)
/*
INSERT INTO study_groups (name, description, subject, creator_id, tags) VALUES
('Flutter Development Study Group', 'Learn Flutter app development together', 'Computer Science', 'your-user-id-here', ARRAY['flutter', 'mobile', 'development']),
('Mathematics Study Circle', 'Advanced mathematics discussion and problem solving', 'Mathematics', 'your-user-id-here', ARRAY['math', 'calculus', 'algebra']),
('Physics Lab Partners', 'Physics experiments and theory discussion', 'Physics', 'your-user-id-here', ARRAY['physics', 'experiments', 'theory']);
*/

-- Insert sample forum topics (uncomment if needed)
/*
INSERT INTO forum_topics (title, content, category, author_id, tags) VALUES
('Best Flutter State Management Solutions', 'What state management solution do you prefer for Flutter apps?', 'Programming', 'your-user-id-here', ARRAY['flutter', 'state-management']),
('Calculus Integration Techniques', 'Share your favorite integration techniques and tips', 'Mathematics', 'your-user-id-here', ARRAY['calculus', 'integration']),
('Physics Lab Report Guidelines', 'How to write effective physics lab reports', 'Physics', 'your-user-id-here', ARRAY['physics', 'lab-reports']);
*/
...
-- The community database setup is now complete!
-- You can now use all the community features in your EduBazaar app.
-- 
-- Next steps:
-- 1. Run this SQL script in your Supabase SQL editor
-- 2. Create the storage buckets mentioned above
-- 3. Test the community features in your app
-- 4. Implement the detail screens for each community feature 
-- Triggers
...
GRANT ALL ON study_resources TO authenticated;
GRANT ALL ON resource_likes TO authenticated;
GRANT ALL ON topic_likes TO authenticated;
GRANT ALL ON reply_likes TO authenticated;

-- Verify the setup
SELECT 'Community database setup completed successfully' as status; 