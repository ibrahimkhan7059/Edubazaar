-- Comprehensive migration script for adding coordinates to listings table
...
-- Add constraint to ensure valid coordinate ranges (optional)
...
-- Update RLS policies if they exist (adjust according to your existing policies)
-- This ensures coordinates are accessible to users who can see listings
